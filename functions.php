...
{
    $query = $connection->prepare("INSERT INTO `star_wars_characters` (`name`, `alignment`, `forcePower`, `lightsaberPower`, `blasterPower`, `image`)
    VALUES (:name, :alignment, :forcePower, :lightsaberPower, :forcePower, :image)");
    $name = $values['name'];
    ...
    $query->bindParam(':alignment', $alignment, PDO::PARAM_STR, 255);
    $query->bindParam(':forcePower', $forcePower, PDO::PARAM_STR, 255);
    $query->bindParam(':lightsaberPower', $lightsaberPower, PDO::PARAM_STR, 255);
    $query->bindParam(':blasterPower', $blasterPower, PDO::PARAM_STR, 255);
